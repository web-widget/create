...
export const WcLitElementMixin = subclass =>
  class extends subclass {
    async execute() {
      ...
      this.copyTemplate(`${__dirname}/templates/my-el.js`, this.destinationPath(`src/${pkgName}.js`));
      this.copyTemplate(`${__dirname}/templates/my-el.widget.js`, this.destinationPath(`src/${pkgName}.widget.js`));
